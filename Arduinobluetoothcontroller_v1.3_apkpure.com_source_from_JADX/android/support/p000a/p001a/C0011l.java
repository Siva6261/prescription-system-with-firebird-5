...
import android.support.v4.p008c.p009a.C0093a;
...
public class C0011l extends C0001k {
    static final Mode f21b = Mode.SRC_IN;
    private C0018s f22c;
    ...
    public static C0011l m26a(Resources resources, int i, Theme theme) {
        if (VERSION.SDK_INT >= 21) {
            ...
            c0011l.a = C0093a.m1308a(resources, i, theme);
    ...
    public int getAlpha() {
        return this.a != null ? C0106a.m1343c(this.a) : this.f22c.f77b.m61a();
    }
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        if (this.a != null) {
            C0106a.m1338a(this.a, resources, xmlPullParser, attributeSet, theme);
            return;
        }
        C0018s c0018s = this.f22c;
    ...
    public void setTintList(ColorStateList colorStateList) {
        if (this.a != null) {
            C0106a.m1336a(this.a, colorStateList);
            return;
        }
        C0018s c0018s = this.f22c;
