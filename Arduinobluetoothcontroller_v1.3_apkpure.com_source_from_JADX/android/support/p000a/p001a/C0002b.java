...
public class C0002b extends C0001k implements Animatable {
    ...
    public void applyTheme(Theme theme) {
        if (this.a != null) {
            C0106a.m1337a(this.a, theme);
        }
    }

    public boolean canApplyTheme() {
        return this.a != null ? C0106a.m1344d(this.a) : false;
    }
    ...
    public int getAlpha() {
        return this.a != null ? C0106a.m1343c(this.a) : this.f7b.f13b.getAlpha();
    }
