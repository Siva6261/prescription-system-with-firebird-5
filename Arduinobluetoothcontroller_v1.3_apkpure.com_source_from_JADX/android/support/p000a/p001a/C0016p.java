...
class C0016p {
    final ArrayList f47a = new ArrayList();
    private final Matrix f48b = new Matrix();
    private float f49c = 0.0f;
    private float f50d = 0.0f;
    private float f51e = 0.0f;
    private float f52f = 1.0f;
    private float f53g = 1.0f;
    private float f54h = 0.0f;
    private float f55i = 0.0f;
    private final Matrix f56j = new Matrix();
    private int f57k;
    private int[] f58l;
    private String f59m = null;

    public C0016p(C0016p c0016p, C0166a c0166a) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (obj instanceof C0016p) {
                this.f47a.add(new C0016p((C0016p) obj, c0166a));
            } else {
                C0013q c0015o;
